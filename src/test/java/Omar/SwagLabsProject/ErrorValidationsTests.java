...
public class ErrorValidationsTests extends BaseTest {
	...
	@Test(groups = { "Login Error Validations" } , retryAnalyzer = Omar.TestComponents.RetryConfig.class)
	...
	@Test(groups = { "Checkout Error Validations" } , retryAnalyzer = Omar.TestComponents.RetryConfig.class)
